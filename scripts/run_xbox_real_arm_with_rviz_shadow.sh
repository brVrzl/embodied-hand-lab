...
ARM_TELEOP_MAX_PALM_VELOCITY_M_S="${ARM_TELEOP_MAX_PALM_VELOCITY_M_S:-0.015}"
ARM_TELEOP_MAX_WRIST_ROLL_VELOCITY_RAD_S="${ARM_TELEOP_MAX_WRIST_ROLL_VELOCITY_RAD_S:-0.08}"
ARM_TELEOP_MAX_JOINT_VELOCITY_RAD_S="${ARM_TELEOP_MAX_JOINT_VELOCITY_RAD_S:-0.12}"
ARM_TELEOP_MAX_JOINT_ACCELERATION_RAD_S2="${ARM_TELEOP_MAX_JOINT_ACCELERATION_RAD_S2:-0.35}"
ARM_TELEOP_MAX_SESSION_EXCURSION_RAD="${ARM_TELEOP_MAX_SESSION_EXCURSION_RAD:-0.20}"
ARM_TELEOP_MAX_SESSION_PALM_EXCURSION_M="${ARM_TELEOP_MAX_SESSION_PALM_EXCURSION_M:-0.08}"
...
ARM_TELEOP_MAX_JOINT_TRACKING_ERROR_RAD="${ARM_TELEOP_MAX_JOINT_TRACKING_ERROR_RAD:-0.012}"
ARM_TELEOP_MAX_JOINT_TRACKING_ERROR_FAULT_RAD="${ARM_TELEOP_MAX_JOINT_TRACKING_ERROR_FAULT_RAD:-0.025}"
