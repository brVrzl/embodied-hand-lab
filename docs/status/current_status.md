...
JAKA sessions. The combined JAKA + RH56 path has since been exercised in
multiple short physical runs, but no run is a complete, long-duration,
all-gates PASS.
...
session 为 0。JAKA + RH56 路径随后已有多次短时真机运行记录，但尚无完整、长期、所有
gate 均 PASS 的联合验证。
