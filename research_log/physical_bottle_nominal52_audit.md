...
- Raw metadata records discovered: **85**
- Complete payload episodes inspected: **84**
- Logical trajectories with payload: **90**
- Audit manifest entries (including excluded no-payload records): **91**
- Clean full-task logical segments: **52**
- Raw merged episodes split: **4**
...
| 150 | CLEAN_FULL_TASK | payload_inspected | 822 | 29.963503949270073 | 1.0 | 822 @ 30.0 | 822 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 151 | CLEAN_FULL_TASK | payload_inspected | 713 | 30.000000300000004 | 1.0 | 713 @ 30.0 | 713 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 152 | CLEAN_FULL_TASK | payload_inspected | 697 | 30.0000003 | 1.0 | 697 @ 30.0 | 697 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 153 | CORRUPT_OR_UNUSABLE | payload_inspected | 410 | 30.0000003 | 1.0 | 410 @ 30.0 | 410 @ 30.0 | operator reported missing; raw payload exists locally but is excluded |
| 154 | CLEAN_FULL_TASK | payload_inspected | 634 | 30.0000003 | 1.0 | 634 @ 30.0 | 634 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 155 | CLEAN_FULL_TASK | payload_inspected | 688 | 30.000000300000004 | 1.0 | 688 @ 30.0 | 688 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 156 | CLEAN_FULL_TASK | payload_inspected | 709 | 30.000000300000004 | 1.0 | 709 @ 30.0 | 709 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 157 | CLEAN_FULL_TASK | payload_inspected | 688 | 30.000000300000004 | 1.0 | 688 @ 30.0 | 688 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 158 | CLEAN_FULL_TASK | payload_inspected | 635 | 30.000000300000004 | 1.0 | 635 @ 30.0 | 635 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 159 | CLEAN_FULL_TASK | payload_inspected | 804 | 30.0000003 | 1.0 | 804 @ 30.0 | 804 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 160 | CLEAN_FULL_TASK | payload_inspected | 856 | 30.0000003 | 1.0 | 856 @ 30.0 | 856 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 161 | CLEAN_FULL_TASK | payload_inspected | 535 | 30.000000300000004 | 1.0 | 535 @ 30.0 | 535 @ 30.0 | operator accepted; raw metadata warning retained; included per operator audit |
| 162 | CLEAN_FULL_TASK | payload_inspected | 671 | 30.0000003 | 1.0 | 671 @ 30.0 | 671 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 163 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 399 | 30.000000300000004 | 1.0 | 399 @ 30.0 | 399 @ 30.0 | operator_review_unusable |
| 164 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 379 | 30.000000300000004 | 1.0 | 379 @ 30.0 | 379 @ 30.0 | operator_review_unusable |
| 165 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 1166 | 30.0000003 | 1.0 | 1166 @ 30.0 | 1166 @ 30.0 | operator_review_unusable |
| 166 | CLEAN_FULL_TASK | payload_inspected | 669 | 30.000000300000004 | 1.0 | 669 @ 30.0 | 669 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 167 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 199 | 30.0000003 | 1.0 | 199 @ 30.0 | 199 @ 30.0 | operator_review_unusable |
| 168 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 1264 | 30.000000300000004 | 1.0 | 1264 @ 30.0 | 1264 @ 30.0 | operator_review_unusable |
| 169 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 1010 | 30.000000300000007 | 1.0 | 1010 @ 30.0 | 1010 @ 30.0 | operator_review_unusable |
| 170 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 155 | 30.000000300000004 | 1.0 | 155 @ 30.0 | 155 @ 30.0 | operator_review_unusable |
| 171 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 220 | 30.000000300000004 | 1.0 | 220 @ 30.0 | 220 @ 30.0 | operator_review_unusable |
| 172 | MERGED_MULTIPLE_EPISODES | payload_inspected | 2402 | 30.0000003 | 1.0 | 2402 @ 30.0 | 2402 @ 30.0 | three operator-reviewed usable demonstrations with reset gaps |
| 173 | CLEAN_FULL_TASK | payload_inspected | 777 | 30.000000300000004 | 1.0 | 777 @ 30.0 | 777 @ 30.0 | operator accepted; task trim removes stationary/reset tail |
| 174 | MERGED_MULTIPLE_EPISODES | payload_inspected | 2092 | 30.000000300000004 | 1.0 | 2092 @ 30.0 | 2092 @ 30.0 | first two demonstrations usable; third missing/incomplete |
| 175 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 1483 | 30.000000300000004 | 1.0 | 1483 @ 30.0 | 1483 @ 30.0 | operator_review_unusable |
| 176 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 198 | 30.000000300000004 | 1.0 | 198 @ 30.0 | 198 @ 30.0 | operator_review_unusable |
| 177 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 1723 | 30.000000300000004 | 1.0 | 1723 @ 30.0 | 1723 @ 30.0 | operator_review_unusable |
| 178 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 256 | 30.000000300000004 | 1.0 | 256 @ 30.0 | 256 @ 30.0 | operator_review_unusable |
| 179 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 227 | 30.000000300000004 | 1.0 | 227 @ 30.0 | 227 @ 30.0 | operator_review_unusable |
| 180 | MANUAL_AUDIT_NON_NOMINAL | payload_inspected | 785 | 30.000000300000004 | 1.0 | 785 @ 30.0 | 785 @ 30.0 | operator_review_unusable |
...
| ep150 | 150 | CLEAN_FULL_TASK | 115–672 | True | operator accepted; pre-task hold and post-task reset tail excluded |
| ep151 | 151 | CLEAN_FULL_TASK | 1–564 | True | operator accepted; post-task reset tail excluded |
| ep152 | 152 | CLEAN_FULL_TASK | 3–547 | True | operator accepted; post-task reset tail excluded |
| ep153 | 153 | CORRUPT_OR_UNUSABLE | 0–release | False |  |
| ep154 | 154 | CLEAN_FULL_TASK | 1–484 | True | operator accepted; post-task reset tail excluded |
| ep155 | 155 | CLEAN_FULL_TASK | 1–538 | True | operator accepted; post-task reset tail excluded |
| ep156 | 156 | CLEAN_FULL_TASK | 19–559 | True | operator accepted; pre-task hold and post-task reset tail excluded |
| ep157 | 157 | CLEAN_FULL_TASK | 1–539 | True | operator accepted; post-task reset tail excluded |
| ep158 | 158 | CLEAN_FULL_TASK | 1–485 | True | operator accepted; post-task reset tail excluded |
| ep159 | 159 | CLEAN_FULL_TASK | 1–654 | True | operator accepted; post-task reset tail excluded |
| ep160 | 160 | CLEAN_FULL_TASK | 1–707 | True | operator accepted; post-task reset tail excluded |
| ep161 | 161 | CLEAN_FULL_TASK | 1–519 | True | operator accepted; included despite preserved metadata warning; post-task tail excluded |
| ep162 | 162 | CLEAN_FULL_TASK | 42–521 | True | operator accepted; pre-task hold and post-task reset tail excluded |
| ep163 | 163 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep164 | 164 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep165 | 165 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep166 | 166 | CLEAN_FULL_TASK | 2–519 | True | operator accepted; post-task reset tail excluded |
| ep167 | 167 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep168 | 168 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep169 | 169 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep170 | 170 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep171 | 171 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep172_a | 172 | CLEAN_FULL_TASK | 0–503 | True | first task; reset interval 504-801 excluded |
| ep172_b | 172 | CLEAN_FULL_TASK | 802–1326 | True | second task; reset interval 1327-1663 excluded |
| ep172_c | 172 | CLEAN_FULL_TASK | 1664–2169 | True | third task; post-task recovery 2170-end excluded |
| ep173 | 173 | CLEAN_FULL_TASK | 1–627 | True | operator accepted; post-task reset tail excluded |
| ep174_a | 174 | CLEAN_FULL_TASK | 0–519 | True | first task; reset interval 520-844 excluded |
| ep174_b | 174 | CLEAN_FULL_TASK | 845–1488 | True | second task; final incomplete task excluded |
| ep174_c | 174 | INCOMPLETE_END | 1794–2091 | False |  |
| ep175 | 175 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep176 | 176 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep177 | 177 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep178 | 178 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep179 | 179 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
| ep180 | 180 | MANUAL_AUDIT_NON_NOMINAL | 0–release | False |  |
...
Episodes 150-180 were added from the 2026-08-13 operator audit. 153 is retained in the source audit because files exist locally, but is excluded because the operator reported it missing.

Episodes 163-165, 167-171, and 175-180 are excluded as operator-marked unusable. Episode 161 is included per the operator's "all other episodes normal" instruction; its raw metadata warning is preserved.

Source 172 is represented by three included logical tasks (172_a, 172_b, 172_c); source 174 by two included tasks (174_a, 174_b) and one excluded incomplete task. Reset/manual-recovery gaps are excluded from every logical segment.

New standalone tasks retain their complete approach through release while removing initial hold and post-task stationary/manual-reset tails. No raw rows or videos are rewritten.
